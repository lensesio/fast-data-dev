...
ARG KAFKA_CONNECT_DEBEZIUM_MONGODB_VERSION=1.4.1.Final
...
ARG KAFKA_CONNECT_DEBEZIUM_MYSQL_VERSION=1.4.1.Final
...
ARG KAFKA_CONNECT_DEBEZIUM_POSTGRES_VERSION=1.4.1.Final
...
ARG KAFKA_CONNECT_DEBEZIUM_SQLSERVER_VERSION=1.4.1.Final
