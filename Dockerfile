...
ARG LKD_VERSION=2.3.2-pre.200523-L0
...
ARG KAFKA_VERSION=2.3.2-pre.200523
...
ARG REGISTRY_VERSION=5.3.3-lkd-r0
...
## Kafka Connect JDBC
ARG KAFKA_CONNECT_JDBC_VERSION=5.3.3-lkd-r0
...
ARG KAFKA_CONNECT_ELASTICSEARCH_VERSION=5.3.3-lkd-r0
...
## Kafka Connect HDFS
ARG KAFKA_CONNECT_HDFS_VERSION=5.3.3-lkd-r0
...
# Kafka Connect S3
ARG KAFKA_CONNECT_S3_VERSION=5.3.3-lkd-r0
