...
ARG REGISTRY_VERSION=5.1.2-lkd-r0
...
ARG STREAM_REACTOR_VERSION=1.2.2
...
## Kafka Connect JDBC
ARG KAFKA_CONNECT_JDBC_VERSION=5.1.2-lkd-r0
...
ARG KAFKA_CONNECT_ELASTICSEARCH_VERSION=5.1.2-lkd-r0
...
## Kafka Connect HDFS
ARG KAFKA_CONNECT_HDFS_VERSION=5.1.2-lkd-r0
...
# Kafka Connect S3
ARG KAFKA_CONNECT_S3_VERSION=5.1.2-lkd-r0
...
ARG AD_UN
ARG AD_PW
ARG AD_URL="https://archive.landoop.com/lenses/2.3/lenses-2.3.8-linux64.tar.gz"
...
ARG CAD_UN
ARG CAD_PW
ARG LC_VERSION="2.3.5"
ARG LC_URL="https://archive.landoop.com/tools/lenses-cli/2.3/$LC_VERSION/lenses-cli-linux-amd64-$LC_VERSION.tar.gz"
