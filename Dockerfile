...
ENV CP_VERSION="3.0.1" KAFKA_VERSION="0.10.0.1"
ARG CP_URL="https://packages.confluent.io/archive/3.0/confluent-oss-${CP_VERSION}-2.11.tar.gz"
...
ARG STREAM_REACTOR_URL=https://archive.landoop.com/third-party/stream-reactor/stream-reactor-v0.2.4_3.0.1.tar.gz
...
ARG TWITTER_CONNECTOR_URL="https://archive.landoop.com/third-party/kafka-connect-twitter/kafka-connect-twitter-0.1-master-af63e4c-cp3.0.1-jar-with-dependencies.jar"
